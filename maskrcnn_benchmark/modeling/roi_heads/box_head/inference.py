...
class PostProcessor(nn.Module):
    ...
    def forward(self, x, boxes):
        ...
        # class_prob = class_logits  # [1000, 21]

        class_prob = F.softmax(class_logits, -1)  # [1000, 21]

        # ccc = class_prob.max(dim=1)

        # ddd = ccc[0].argmax(dim=0)
        # print('ddd: ', ddd)
        ...
        class_prob = class_prob.split(boxes_per_image, dim=0)  # [1000, 21]
