...
class RPNLossComputation(object):
    ...
    def __call__(self, anchors, objectness, box_regression, targets):
        ...
        objectness_loss = F.binary_cross_entropy_with_logits(torch.cat([objectness[sampled_inds], closeup_objectness], dim=0), torch.cat([labels[sampled_inds], fakelabel], dim=0))
