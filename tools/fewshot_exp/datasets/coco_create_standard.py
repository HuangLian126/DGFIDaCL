...
import random
random.seed(0)
yolodir = '/home/hl/hl/ourMetaWithoutFPN/Fewshot_Detection-master'
train = json.load(open('/home/hl/hl/ourMetaWithoutFPN/datasets/coco/annotations/instances_train2014.json'))
val = json.load(open('/home/hl/hl/ourMetaWithoutFPN/datasets/coco/annotations/instances_valminusminival2014.json'))
minival = json.load(open('/home/hl/hl/ourMetaWithoutFPN/datasets/coco/annotations/instances_minival2014.json'))
...
for shot in [10, 30]:
    ...
    for split in ['train', 'val']:
        ...
        json.dump(n_json, open('/home/hl/hl/ourMetaWithoutFPN/datasets/coco/annotations/instances_%s2014_%dshot_novel_standard.json'%(split, shot), 'w+'))
