...
import json
# /home/hl/hl/ourMetaWithoutFPN/datasets/coco/annotations/instances_valminusminival2014.json
def dele(split):
    with open('/home/hl/hl/ourMetaWithoutFPN/datasets/coco/annotations/instances_' + split + '2014.json', 'r') as f:
        o_annos = json.load(f)
    ...
    json.dump(n_annos, open('/home/hl/hl/ourMetaWithoutFPN/datasets/coco/annotations/instances_' + split + '2014_base.json', 'w+'))
